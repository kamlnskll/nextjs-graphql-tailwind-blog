    ...
    <div className="mb-8 rounded-lg bg-white p-0 pb-12 shadow-lg lg:p-8">
      <div className="relative mb-6 overflow-hidden pb-80 shadow-md">
        <img
          ...
          alt={post.title}
          className="absolute h-80 w-full rounded-r-lg object-cover object-top shadow-lg lg:rounded-lg"
        />
      </div>
      {/* The post title is displayed here */}
      <h1 className="cursor:pointer duration-400 mb-8 text-center text-3xl font-semibold transition hover:text-pink-600">
      ...
      <div className="mb-8 block w-full items-center justify-center text-center lg:flex">
        <div className="mb-4 mr-8 flex w-full items-center justify-center lg:mb-0 lg:w-auto">
          ...
          />
          <p className="ml-2 inline align-middle text-lg text-gray-600">
            {post.author.name}
          </p>
        </div>
